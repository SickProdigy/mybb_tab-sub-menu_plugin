...
$l['tab_sub_menu_setting_selection_mode_title'] = '选择模式';
$l['tab_sub_menu_setting_selection_mode_description'] = '仅选择顶级分类，或允许标签包含单独的论坛和分类。';
$l['tab_sub_menu_setting_selection_mode_top'] = '顶级分类';
$l['tab_sub_menu_setting_selection_mode_all'] = '所有论坛和分类';
...
$l['tab_sub_menu_editor_search'] = '搜索论坛和分类';
$l['tab_sub_menu_editor_apply_selection'] = '应用选择';
$l['tab_sub_menu_editor_cancel'] = '取消';
$l['tab_sub_menu_editor_picker_title'] = '选择论坛和分类';
$l['tab_sub_menu_editor_show_all_help'] = '不选择任何项目即可显示所有论坛。';
$l['tab_sub_menu_editor_category_type'] = '分类';
$l['tab_sub_menu_editor_forum_type'] = '论坛';
