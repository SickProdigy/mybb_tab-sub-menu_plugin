...
$l['tab_sub_menu_setting_selection_mode_title'] = 'Selection Mode';
$l['tab_sub_menu_setting_selection_mode_description'] = 'Choose top-level categories only, or allow tabs to contain individual forums and categories.';
$l['tab_sub_menu_setting_selection_mode_top'] = 'Top-level categories';
$l['tab_sub_menu_setting_selection_mode_all'] = 'All forums and categories';
...
$l['tab_sub_menu_editor_search'] = 'Search forums and categories';
$l['tab_sub_menu_editor_apply_selection'] = 'Apply selection';
$l['tab_sub_menu_editor_cancel'] = 'Cancel';
$l['tab_sub_menu_editor_picker_title'] = 'Choose forums and categories';
$l['tab_sub_menu_editor_show_all_help'] = 'Select nothing to show all forums.';
$l['tab_sub_menu_editor_category_type'] = 'Category';
