...
$l['tab_sub_menu_setting_selection_mode_title'] = 'Mode de sélection';
$l['tab_sub_menu_setting_selection_mode_description'] = 'Choisissez uniquement les catégories principales ou autorisez des forums et catégories individuels dans les onglets.';
$l['tab_sub_menu_setting_selection_mode_top'] = 'Catégories de premier niveau';
$l['tab_sub_menu_setting_selection_mode_all'] = 'Tous les forums et catégories';
...
$l['tab_sub_menu_editor_search'] = 'Rechercher des forums et catégories';
$l['tab_sub_menu_editor_apply_selection'] = 'Appliquer la sélection';
$l['tab_sub_menu_editor_cancel'] = 'Annuler';
$l['tab_sub_menu_editor_picker_title'] = 'Choisir des forums et catégories';
$l['tab_sub_menu_editor_show_all_help'] = 'Ne sélectionnez rien pour afficher tous les forums.';
$l['tab_sub_menu_editor_category_type'] = 'Catégorie';
$l['tab_sub_menu_editor_forum_type'] = 'Forum';
